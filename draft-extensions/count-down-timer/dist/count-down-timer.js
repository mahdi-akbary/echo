...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  // extensions/count-down-timer/src/index.jsx
...
${errorInfo.componentStack}`);
  ...
  function App() {
    ...
    const [countdown, setCountdown] = (0, import_react14.useState)(timeStartAt * 60);
    (0, import_react14.useEffect)(() => {
      const retrieveCountdown = () => __async(this, null, function* () {
        const storedCountdown = yield get("countdown");
        if (storedCountdown !== void 0) {
    ...
    const message = countdown_message ? countdown_message : "\u{1F525} Items in your cart are in high demand. No worries, we have reserved your order for $timer";
    return isClassic ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(TextBlock2, { inlineAlignment: alignmentStyle, children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Heading2, { alignmentStyle, children: title != null ? title : "Count down timer" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockSpacer2, { spacing: "extraTight" }),
      countdown > 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        Text2,
        {
          size: fontSizeStyle,
          emphasis: emphasisStyle,
          appearance: statusStyle,
          children: message.replace("$timer", countdownString)
        }
        ...
        Text2,
        {
          ...
          children: [
            " ",
            countdown_message_after != null ? countdown_message_after : "You're out of time! Checkout now to avoid losing your order!"
          ]
        }
      )
    ] }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Banner2, { title: title != null ? title : "Count down timer", status: statusStyle, children: countdown > 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      Text2,
      {
        size: fontSizeStyle,
        emphasis: emphasisStyle,
