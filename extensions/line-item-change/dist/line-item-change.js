...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  // extensions/line-item-change/src/index.jsx
  ...
  // node_modules/@shopify/ui-extensions/build/esm/surfaces/checkout/components/Stepper/Stepper.mjs
  var Stepper = createRemoteComponent("Stepper");
...
${errorInfo.componentStack}`);
  ...
  // node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/components/Stepper/Stepper.mjs
  var Stepper2 = createRemoteReactComponent(Stepper);
  ...
  function App() {
    ...
    show_quantity = show_quantity === void 0 ? true : show_quantity;
    show_remove_button = show_remove_button === void 0 ? true : show_remove_button;
    show_variants = show_variants === void 0 ? true : show_variants;
    const applyCartLinesChange = useApplyCartLinesChange();
    const currentCartLine = useTarget();
    const [quantityError, setQuantityError] = (0, import_react21.useState)(null);
    const [loading, setLoading] = (0, import_react21.useState)(false);
    const [variantError, setVariantError] = (0, import_react21.useState)(null);
    const [variants, setVariants] = (0, import_react21.useState)(currentCartLine.variants);
    const changeCartLine = (data) => __async(this, null, function* () {
      setLoading(true);
      const result = yield applyCartLinesChange(data);
    ...
    const handleRemoveCartLine = () => __async(this, null, function* () {
      yield changeCartLine({
        type: "removeCartLine",
        id: currentCartLine.id,
    ...
    const handleVariantChange = (value) => __async(this, null, function* () {
      yield changeCartLine({
        type: "updateCartLine",
        id: currentCartLine.id,
        merchandiseId: value,
      ...
      function getVariants() {
        return __async(this, null, function* () {
          ...
          product(id: $id) {
            ...
            {
              variables: { id: (_b = (_a = currentCartLine.merchandise) == null ? void 0 : _a.product) == null ? void 0 : _b.id }
            }
          );
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(InlineStack2, { spacing: "base", blockAlignment: "center", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Text2, { size: "small", children: [
        "Quantity: ",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        Link2,
        {
          overlay: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Popover2, { position: "blockEnd", minInlineSize: 240, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { padding: "base", spacing: "base", children: [
            show_quantity && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(InlineLayout2, { columns: quanityRemoveColums, spacing: "base", children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { maxInlineSize: show_remove_button ? 170 : "", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                Stepper2,
                {
                  min: 1,
                  disabled: loading,
              ...
              show_remove_button && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                Button2,
                {
                  disabled: loading,
                  appearance: "critical",
            ...
            show_variants && (variants == null ? void 0 : variants.length) > 1 && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
              show_quantity && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(View2, { spacing: "base", children: [
                " ",
              ...
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                Select2,
                {
                  ...
                  options: variants == null ? void 0 : variants.map((variant) => {
                    return {
            ...
            quantityError && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { padding: "none", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { appearance: "critical", size: "small", children: quantityError }) })
          ] }) }),
          children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { size: "small", children: "Change" })
        }
      ),
      loading ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Spinner2, { size: "small", appearance: "accent" }) : null
    ] });
  }
})();
