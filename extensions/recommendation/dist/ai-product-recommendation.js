...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  // extensions/recommendation/src/index.jsx
...
${errorInfo.componentStack}`);
  ...
  // extensions/recommendation/src/getCountryCode.jsx
  ...
  // extensions/recommendation/src/productCard.jsx
  ...
  function ProductCard({ product, baseUrl }) {
    ...
    const [activeVariant, setActiveVariant] = (0, import_react21.useState)(
      (_a = product == null ? void 0 : product.variants) == null ? void 0 : _a.edges.find((variant) => variant.node.availableForSale)
    );
    const [loading, setLoading] = (0, import_react21.useState)(false);
    const applyCartLinesChange = useApplyCartLinesChange();
    const storeCartItem = () => __async(this, null, function* () {
      try {
        const token = yield sessionToken.get();
        const response = yield fetch(`${baseUrl}/api/cart-items`, {
          method: "POST",
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json"
          },
          body: JSON.stringify(__spreadProps(__spreadValues({}, activeVariant.node), {
    ...
    function handleAddToCart() {
      return __async(this, null, function* () {
        ...
        const result = yield applyCartLinesChange(newCartLines);
      ...
      InlineLayout2,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(TextBlock2, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { size: "base", emphasis: "bold", children: product.title }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockSpacer2, { spacing: "extraTight" }),
            !includePrice && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Text2, { size: button_size, appearance: "subdued", children: [
              " ",
              firstVariantPrice(product),
              " "
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockSpacer2, { spacing: "extraTight" }),
            showVariants && ((_c = (_b = product == null ? void 0 : product.variants) == null ? void 0 : _b.edges) == null ? void 0 : _c.length) > 1 && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
              Select2,
              {
            ...
            error && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(View2, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockSpacer2, { spacing: "extraTight" }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Text2, { appearance: "critical", size: "small", padding: "extraTight", children: [
                " ",
                error,
                " "
              ] })
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { inlineAlignment: "end", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            Button2,
            {
              kind: button_style ? button_style : "primary",
              loading,
              disabled: error,
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
                InlineStack2,
                {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { size: button_size, children: addToCartLabel }) }),
                    includePrice && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
                      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(TextBlock2, { children: " \u2022 " }),
                      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { size: button_size, children: firstVariantPrice(product) })
                    ] })
                  ]
                }
              )
    ...
    function firstVariantPrice(product2) {
      const price = product2.variants.edges[0].node.price.amount;
      return i18n.formatCurrency(price, { currencyCode }).replace(/\.\d+$/, "");
    }
  }

  // extensions/recommendation/src/productList.jsx
  ...
  function ProductList({ product }) {
    ...
    const addToCartLabel = add_to_cart_label ? add_to_cart_label : "Add to cart";
    const includePrice = include_price ? true : false;
    const [activeVariant, setActiveVariant] = (0, import_react22.useState)((_a = product == null ? void 0 : product.variants) == null ? void 0 : _a.edges.find((variant) => variant.node.availableForSale));
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
      BlockLayout2,
      {
        ...
        padding,
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(View2, { children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
            Image2,
            {
              border: border ? "none" : "base",
              cornerRadius: "base",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(View2, { inlineAlignment: "start", children: [
            /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(Text2, { size: "base", emphasis: "bold", children: [
              " ",
              product.title,
              " "
            ] }),
            showVariants && ((_c = (_b = product == null ? void 0 : product.variants) == null ? void 0 : _b.edges) == null ? void 0 : _c.length) > 1 && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
              Select2,
              {
                label: "Select variant",
                value: activeVariant.node.id,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(View2, { children: [
            !includePrice && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(Text2, { size: button_size, appearance: "subdued", children: [
              " ",
              firstVariantPrice(product),
              " "
            ] }),
            ...
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
              Button2,
              {
                ...
                disabled: error,
                onPress: handleAddToCart,
                children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(InlineStack2, { spacing: "tight", blockAlignment: "center", inlineAlignment: "center", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(View2, { children: addToCartLabel }),
                  includePrice && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
                    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(View2, { children: " \u2022 " }),
                    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Text2, { children: firstVariantPrice(product) })
                  ] })
                ] })
              }
            )
  ...
  var BASE_URL = "https://checkout-plus.fly.dev";
  var src_default = reactExtension("purchase.checkout.block.render", () => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(App, {}));
  function App() {
    ...
    let recommendationSourceID = (_c = (_b = (_a = cartLines[0]) == null ? void 0 : _a.merchandise) == null ? void 0 : _b.product) == null ? void 0 : _c.id;
    if (recommendationSource == "first") {
      recommendationSourceID = (_f = (_e = (_d = cartLines[0]) == null ? void 0 : _d.merchandise) == null ? void 0 : _e.product) == null ? void 0 : _f.id;
    } else if (recommendationSource == "last") {
      recommendationSourceID = (_i = (_h = (_g = cartLines[cartLines.length - 1]) == null ? void 0 : _g.merchandise) == null ? void 0 : _h.product) == null ? void 0 : _i.id;
      ...
      recommendationSourceID = (_l = (_k = (_j = cartLines[maxPriceIndex]) == null ? void 0 : _j.merchandise) == null ? void 0 : _k.product) == null ? void 0 : _l.id;
      ...
      recommendationSourceID = (_o = (_n = (_m = cartLines[minPriceIndex]) == null ? void 0 : _m.merchandise) == null ? void 0 : _n.product) == null ? void 0 : _o.id;
    }
    const userCountryCode = getCountryCode(currencyCode);
    (0, import_react23.useEffect)(() => {
      query(
        `query Recommendations @inContext(country: ${userCountryCode != null ? userCountryCode : "US"}) {
    ...
    let productList = (_p = data == null ? void 0 : data.productRecommendations) == null ? void 0 : _p.filter((product) => {
      return product.availableForSale && !cartProductIDs.includes(product.id);
    });
    productList = productList == null ? void 0 : productList.slice(0, recommendationLimit);
    let hasProduct = true;
    if ((productList == null ? void 0 : productList.length) == 0) {
      hasProduct = false;
    }
    return hasProduct ? /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Heading2, { children: bannerTitle }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(BlockSpacer2, {}),
      recommendationLayout == "grids" ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Grid2, { spacing: "tight", columns: gridLayout, children: productList == null ? void 0 : productList.map(
        (product) => {
      ...
      ) }) : /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(BlockLayout2, { spacing: "tight", rows: "auto", columns: "1fr", children: productList == null ? void 0 : productList.map(
        (product) => {
          return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
            ProductCard,
            {
