...
${errorInfo.componentStack}`);
  ...
  // extensions/survey/src/Checkout.jsx
    ...
    function handleSubmit() {
      return __async(this, null, function* () {
        ...
        try {
          ...
          const response = yield fetch(`${baseUrl}/api/surveys`, {
            method: "POST",
            headers: {
  ...
  function Survey({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { border: "base", padding: "base", borderRadius: "base", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { children: [
      ...
      children,
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Button2, { kind: "secondary", onPress: handleSubmit, loading, children: submitText != null ? submitText : "Submit Survey" })
    ] }) });
  }
